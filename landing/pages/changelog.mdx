...
- Favourites support. Add your favourite resources, they will always be on top of the resources list.
- Adds `logs` alias for CloudWatch and `fargate` for ECS
- Adds button to open CloudTempo next to the AWS native resource search
- Fixes problem with the view being scrollable when modal is open
- Styling issues

## 0.1.1 - 11 / 10 / 2022

- Onboarding experience
- Add an ability to toggle between dark mode and light mode in AWS Console
