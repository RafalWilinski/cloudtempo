  ...
  return (
    <>
      <Command.Group heading="Actions">
        ...
        <Command.Item
          value="Enable AWS Console Dark Mode"
          onSelect={() => {
            Cookies.set("awsc-color-theme", "dark", {
              domain: ".amazon.com",
              expires: 365,
            });
            location.reload();
        ...
        >
          ...
          AWS Console Dark Mode: Enable
        </Command.Item>
        <Command.Item
          value="Disable AWS Console Dark Mode"
          onSelect={() => {
            Cookies.set("awsc-color-theme", "light", {
              domain: ".amazon.com",
              expires: 365,
            });
            location.reload();
